...
Install the included `oniprofiler_control-1.0.0rc1-py3-none-any.whl` into Python 3.11+ in a virtual environment. Alternatively install `./controlplane` from source:
